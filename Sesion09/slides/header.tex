...
\definecolor{utpNaranja}{HTML}{C1670B}
...
% La rotación indica hacia dónde está la entidad: 0 derecha, 180 izquierda,
% 90 arriba, -90 abajo. La pata se abre hacia la entidad del lado "muchos".
\tikzset{
  relacion/.style={thick, draw=utpNegro},
  pics/uno/.style={code={%
    \draw[thick,utpNegro,line cap=round] (0,-1.5mm) -- (0,1.5mm);}},
  pics/muchos/.style={code={%
    \draw[thick,utpNegro,line cap=round,line join=round]
      (2.6mm,1.5mm) -- (0,0) -- (2.6mm,-1.5mm);
    \draw[thick,utpNegro,line cap=round] (0,0) -- (2.6mm,0);}},
}
\newcommand{\simbuno}{\tikz[baseline=-0.6ex]{\draw[relacion](0,0)--(7mm,0);\pic at (4.4mm,0){uno};}}
\newcommand{\simbmuchos}{\tikz[baseline=-0.6ex]{\draw[relacion](0,0)--(7mm,0);\pic at (4.4mm,0){muchos};}}
